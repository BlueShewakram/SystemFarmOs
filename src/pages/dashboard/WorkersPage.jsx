...
const WorkersPage = () => {
  ...
  const handleAddWorker = async (e) => {
    ...
    try {
      ...
      // Bug fix: insert failures now surface, and the table refreshes from Supabase after a successful create.
      ...
      setErrorMessage('Failed to add worker: ' + err.message);
    } finally {
      setSaving(false);
    }
  };
        ...
        <div className="modal-overlay">
          <div className="modal-content fade-up" role="dialog" aria-modal="true" aria-labelledby="add-worker-title">
            <div className="modal-header">
              <h3 id="add-worker-title">Add New Worker</h3>
